/**
 * 前期谋划 · 更新片区 geojson 数据加载与聚合（packages/shared/components/data/area_merged_all.geojson）
 *
...
import areaGeojsonUrl from '@jeesite/shared/components/data/area_merged_all.geojson?url';
